                ...
                <div class="panel panel-default">
                	<div class="panel-heading">
                      	<div class="panel-title"> 
                      	    <marquee direction="right">  <a style="color:red"><strong style="font-size:20px;"><i class="glyphicon glyphicon-link"></i>  &nbsp; Add New Study Notification</strong></a>  </marquee>
                      	</div>
                	</div>
                        ...
                        <?php
                            if(isset($_POST['add']))
                            {
                              $subject=$_POST['subject'];
                                ...
                                $qry="INSERT INTO `notification`( `notification_type`, `notification_content`, `dept_id`, `faculty_id`,`day`,`subject_id`) VALUES ('$notification_type','$notification_content','$dept_id','$faculty_id','$day','$subject')";
                                $exc=mysqli_query($conn,$qry);
                                if($exc){
                                    echo "<script>alert('Data added..');
                                            window.location='view_study_notification.php';
                                    </script>";
                                }
                                else
                                {
